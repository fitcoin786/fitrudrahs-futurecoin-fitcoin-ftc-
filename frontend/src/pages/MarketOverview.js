      ...
      <nav className="glass-nav border-b border-white/5 sticky top-0 z-50">
        <div className="max-w-[1920px] mx-auto flex items-center justify-between px-6 py-4">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="https://fitcoin-platform.preview.emergentagent.com/" target="_blank" rel="noopener noreferrer" className="text-[#00F090] hover:text-[#00F090]/80 transition-colors font-bold uppercase tracking-wider text-sm">⛏️ Mine FTC</a>
